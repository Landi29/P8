...
SMALL_GRAPH_FOLDER_PATH = pathlib.Path.cwd() / 'Movielens_data' / 'small_graph'
SMALL_N2V_MODEL_PATH_DATFILE = pathlib.Path.cwd() / 'n2v_models' / 'n2vmodel.pkl'
SMALL_N2V_MODEL_PATH_1M = pathlib.Path.cwd() / 'n2v_models' / 'n2vmodel_1m.pkl' 
SMALL_N2V_MODEL_PATH_2M = pathlib.Path.cwd() / 'n2v_models' / 'n2vmodel_2m.pkl' 
