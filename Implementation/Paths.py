...
SMALL_GRAPH_RATINGS_PATH = pathlib.Path.cwd() / 'Movielens_data' / 'small_graph' / 'ratings.dat' 
SMALL_N2V_MODEL_PATH = pathlib.Path.cwd() / 'n2v_models' / 'n2vmodel.pkl' 
SMALL_N2V_MODEL_PATH_2 = pathlib.Path.cwd() / 'n2v_models' / 'n2vmodel2.pkl' 
