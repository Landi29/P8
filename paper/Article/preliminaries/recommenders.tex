...
Collaborative filtering-based recommenders defined in definition \autoref{def:Collaborative_filtering_based}, depend on data from other items or users. These systems therefore give users trust\autoref{def:trust} in the answer but often have the cold start problem \autoref{def:cold_start_problem}.
