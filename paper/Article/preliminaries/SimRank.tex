...
\begin{definition}[Bipartite SimRank]\label{def:bipartite_simrank} Let s(A,B) be the similarity between two objects A and B of type user and for items we denote it as s(M1,M2) where M1 and M2 are movies. $C_1$ and $C_2$ are both constants between 0 and 1.
