...
Once node-level embedding have been computed the first strategy can use these to compute the graph-level embeddings. Here Bai et al present an attention mechanism that is used to figure out which nodes are more important than other and consequently should therefore receive more weights\cite{Bai2018}. The equation for the attention mechanism can be seen below:
