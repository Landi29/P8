...
% If Rating(u,m) \ rightarrow \{Low, Mid, High\}, how come Rating(u,m)& \longrightarrow Action(m) \\
% This tries to explaine what is written in equation 11, but it is not mathematically correct.
