...
We made this scenario by artificially removing any relation to all the movies in verification and test sets from allll users in the traning set , making the predictions for a single person.
