...
Looking at the different runtimes we see that node2vec is the fastest recommender and that the TETs takes 1000 times longer to make a recommendation this could potentially be improved by implementing a matrix containing the simulates, instead of calculating them for each user in runtime.
