\subsection{TET Histograms and Distance}
	...
	On the genre level of the TET structure we find the different substructures for each structure in the earlier histogram, for example in  \autoref{fig:Tethistogram} we have the structure  $low\{(a:t)(c:t)(r:t)\}$ and the substructure would be  $(a:t)(c:t)(r:t)$. We can use manhatten distance at this level by considering it as a vector, there comparison with another histogram with less true genre features than the other can then be compared as seen in \autoref{Eq:manhattencomparason}\cite{singh2013k}.
