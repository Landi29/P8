\subsection{Brute force comparison}\label{brute_force}
...
This can then be extended to all product relations $P$ as seen in \autoref{eq:manhat}\todo{skal vi ikke have et sted hvor der står $p \in P$}
