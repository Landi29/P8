...
\fill[black!70!white] (0,0) rectangle (1,1);
\fill[black!30!white] (1,0) rectangle (10,1);
\draw[step=1cm,black,thick] (0,0) grid (10,1);

\fill[black!70!white] (1,-2) rectangle (2,-1);
\fill[black!30!white] (0,-2) rectangle (1,-1);
\fill[black!30!white] (2,-2) rectangle (10,-1);
\draw[step=1cm,black,thick] (0,-1) grid (10,-2);

\node[thick] at (5,-2.45) {$\vdots$};

\fill[black!70!white] (9,-4) rectangle (10,-3);
\fill[black!30!white] (0,-4) rectangle (9,-3);
